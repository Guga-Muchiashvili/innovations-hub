...
import localIcon from "../../../public/localicon.png";
...
export default function LocalDetailCard({ onClose }: { onClose: () => void }) {
        ...
        <div className="absolute top-0 z-20 w-full h-12 flex justify-between">
          <div className="flex pl-3 pt-3 w-1/2 md:w-2/6 gap-2 text-white text-xs items-center">
            <Image
              ...
              className="w-8 h-8"
            />
            <h1 className="text-lg">ლოკალური</h1>
          </div>
          <div className="w-[45%] md:w-[55%] h-full bg-white items-center translate-y-[-1px] flex pb-4 justify-end z-30 rounded-bl-3xl">
            <h1 className="text-[#1A3765] text-xs lg:text-lg font-semibold text-center w-full xl:text-right xl:mr-6">
              დედლაინი : 04.05.2025
            </h1>
          </div>
        </div>
        ...
        >
          ...
          {showFlightInformation && (
            ...
            >
              ...
              <h1 className="mt-4 lg:mt-2 w-full lg:text-sm 2xl:text-base ">
                ხანგრძლივობა : 3 თვე
              </h1>
              <div className="flex items-center gap-3 mt-5 lg:mt-4 xl:mt-6 2xl:mt-8 w-full">
