  ...
  return (
    <div className="w-full px-10 z-40">
      ...
      <div className="w-full flex pb-5 h-fit flex-wrap gap-4 justify-center overflow-hidden">
        <div className="w-full px-10 flex h-[calc(100vh-9rem)] flex-wrap gap-2 py-2 justify-center overflow-y-auto hide-scrollbar scroll-smooth">
          {Array.from({ length: 14 }).map((_, index) => (
            <ExchangeCardElement key={index} />
          ))}
        </div>
      </div>
    </div>
